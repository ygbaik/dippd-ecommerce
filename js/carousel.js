...
function resizeCells() {
  ...
  jQuery('.carousel-items .carousel-post').removeClass("nextToSelectedLeft");
  jQuery('.carousel-items .carousel-post').removeClass("nextToSelectedRight");
  jQuery('.carousel-items .carousel-post').removeClass("nextToSelectedLeft2");
  jQuery('.carousel-items .carousel-post').removeClass("nextToSelectedRight2");
  jQuery('.carousel-items .carousel-post').eq($current - 1).addClass("nextToSelectedLeft");
  jQuery('.carousel-items .carousel-post').eq($current - 2).addClass("nextToSelectedLeft2");
  var $endCell;
  if ($current + 1 == $length) {
    $endCell = "0";
  } else {
...
$('.carousel-post').bind("mouseover", function(){
  ...
  } else if (this.className === 'carousel-post nextToSelectedRight') {
    $imagesCarousel.flickity('playRightSlowPlayer');
  } else if (this.className === 'carousel-post nextToSelectedRight2') {
